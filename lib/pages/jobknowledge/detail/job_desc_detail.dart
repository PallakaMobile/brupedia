...
class JobDescDetailPage extends StatefulWidget with NavigationStates {
  JobDescDetailPage({Key key}) : super(key: key);

  @override
  _JobDescDetailPageState createState() => _JobDescDetailPageState();
}

class _JobDescDetailPageState extends State<JobDescDetailPage> {
  @override
